...
CRYPTO_BUY_BLOCKED_LOW_BUYING_POWER: Final[str] = "CRYPTO_BUY_BLOCKED_LOW_BUYING_POWER"
CRYPTO_BUY_BLOCKED_ALREADY_HOLDING: Final[str] = "CRYPTO_BUY_BLOCKED_ALREADY_HOLDING"
CRYPTO_BUY_BLOCKED_COOLDOWN: Final[str] = "CRYPTO_BUY_BLOCKED_COOLDOWN"
CRYPTO_BUY_BLOCKED_MAX_POSITIONS: Final[str] = "CRYPTO_BUY_BLOCKED_MAX_POSITIONS"
CRYPTO_BUY_BLOCKED_SCORE: Final[str] = "CRYPTO_BUY_BLOCKED_SCORE"
CRYPTO_PUSH_DISABLED: Final[str] = "CRYPTO_PUSH_DISABLED"

CRYPTO_TAKE_PROFIT: Final[str] = "CRYPTO_TAKE_PROFIT"
CRYPTO_TRAILING_STOP: Final[str] = "CRYPTO_TRAILING_STOP"
CRYPTO_STOP_LOSS: Final[str] = "CRYPTO_STOP_LOSS"
CRYPTO_MAX_HOLD_TIME: Final[str] = "CRYPTO_MAX_HOLD_TIME"
...
ALL_CODES: Final[tuple[str, ...]] = (
    ...
    MAX_HOLD,
    EMERGENCY_EXIT,
    CRYPTO_BUY_BLOCKED_LOW_BUYING_POWER,
    CRYPTO_BUY_BLOCKED_ALREADY_HOLDING,
    CRYPTO_BUY_BLOCKED_COOLDOWN,
    CRYPTO_BUY_BLOCKED_MAX_POSITIONS,
    CRYPTO_BUY_BLOCKED_SCORE,
    CRYPTO_PUSH_DISABLED,
    CRYPTO_TAKE_PROFIT,
    CRYPTO_TRAILING_STOP,
    CRYPTO_STOP_LOSS,
    CRYPTO_MAX_HOLD_TIME,
)
