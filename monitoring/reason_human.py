...
_ARCHITECTURE_BLOCKER_MAP: dict[str, str] = {
    ...
    "capital_recovery_active": "Capital recovery mode — restore cash before new buys.",
    "capital_sleeve_audit_missing": "Sleeve enforcement audit not available.",
    "fast_loop_scoring_diagnostics_missing": "Fast loop ran but per-symbol scoring diagnostics are missing.",
    "fast_loop_execution_readiness_blocked": "Fast-loop paper execution readiness checks not passing.",
