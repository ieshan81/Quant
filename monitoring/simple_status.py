...
def build_simple_worker_status() -> dict[str, Any]:
    ...
    return {
        ...
        "worker": {
            ...
            "last_cycle_duration_ms": hb.get("last_cycle_duration_ms"),
            "max_cycle_duration_ms_recent": hb.get("max_cycle_duration_ms_recent"),
            "last_slow_cycle_stage": hb.get("last_slow_cycle_stage"),
            "last_slow_cycle_duration_ms": hb.get("last_slow_cycle_duration_ms"),
        ...
        "trading": {
            ...
            "candidate_symbol": (hb.get("candidate_symbol") or None),
